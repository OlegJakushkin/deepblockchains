...
only a few ``off-chain'' attempts can be considered a deep blockchain because they lack the connected blockchains.  Layer $i+1$ and layer $i$  may be explicitly connected in a deep blockchain system for many different reasons:
\begin{enumerate}
